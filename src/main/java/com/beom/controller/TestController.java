...
import com.beom.dto.OrderRequest;
...
public class TestController {
    ...
    @PostMapping("/order")
    public ResponseEntity<OrderRequest> order(@RequestHeader("traceId") String traceId ,@RequestBody OrderRequest orderRequest) {
        log.info("HEADER : {} , BODY : {}",traceId,orderRequest.toString());
